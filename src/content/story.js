...
export const storyChapters = [
  ...
  },
  {
    ...
    body: [
      'The next morning is methodical. Prayer, meditation, patients. Checkups and appointments. The business of Restoration Care is enjoyable. We serve God and we serve the community. Hillpoint is a small farm village not far outside of town. Few end up here on purpose. Even fewer end up staying long term. The families that populate the village have been here for generations. So you knew most of the faces around the village. Everyone\'s business would end up in the wind faster than a toddler holding something they should not have.',
      ...
      'Sister Lakethia is in with her son and daughter. Her son sprained his ankle playing ball. She uses this as an excuse to talk and gossip. Jon comes in as I am finishing up with the boy. He spends the mornings repairing, building, or whatever odd job that might be needed around town for credits before helping in the practice in the afternoons.',
